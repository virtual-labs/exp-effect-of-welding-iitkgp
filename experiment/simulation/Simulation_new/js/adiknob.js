...
function adi(){
    ...
    $(".adik2").css({'z-index':'2', 'left':0.695*Number($("#adisimg").width()), 'top':-0.535*Number($("#adisimg").width()), 'margin-bottom':'-6.5em'});
    $(".adig2").css({'z-index':'2', 'left':0.82*Number($("#adisimg").width()),'top':-0.535*Number($("#adisimg").width()), 'margin-bottom':'-6.5em'});
    $(".adik3").css({'z-index':'2', 'left':0.695*Number($("#adisimg").width()), 'top':-0.445*Number($("#adisimg").width()), 'margin-bottom':'-6.5em'});
    $(".adig3").css({'z-index':'2', 'left':0.82*Number($("#adisimg").width()),'top':-0.455*Number($("#adisimg").width()), 'margin-bottom':'-6.5em'});
