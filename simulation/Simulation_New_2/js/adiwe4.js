...
function adiwe4(a){
    ...
    else
    {
        ...
        if(a==1){
            ...
            $("#adis").hide();
            if(Number($("#ar1").val())>24 && Number($("#ar1").val())<42 || Number($("#ar2").val())>19 && Number($("#ar2").val())<31 || Number($("#ar3").val())>179 && Number($("#ar3").val())<361 || Number($("#ar4").val())>1.2 && Number($("#ar4").val())<1.6){
                $("#adiv").show();
